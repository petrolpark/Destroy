...
import com.petrolpark.destroy.chemistry.index.genericreaction.AcylChlorideHydration;
...
public class DestroyGenericReactions {
    ...
    public static final AcylChlorideHydration ACYL_CHLORIDE_HYDRATION = new AcylChlorideHydration();
