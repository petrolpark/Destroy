...
public class DestroyItems {
    ...
    public static final RegistryObject<Item> DEPLETED_CONVERSION_CATALYST = ITEMS.register("depleted_conversion_catalyst",
        () -> new Item(new Item.Properties().tab(DestroyCreativeModeTabs.TAB_DESTROY))
    );
    ...
    public static final RegistryObject<Item> DIRTY_PALLADIUM_ON_CARBON = ITEMS.register("dirty_palladium_on_carbon",
        () -> new Item(new Item.Properties().tab(DestroyCreativeModeTabs.TAB_DESTROY))
    );
